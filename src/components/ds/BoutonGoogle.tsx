...
export function BoutonGoogle({
  ...
  return (
    <button
      ...
      onClick={onClick}
      disabled={chargement}
      className="h-[46px] w-full flex items-center justify-center gap-2.5 text-[15px] font-medium cursor-pointer disabled:opacity-60 disabled:cursor-not-allowed transition-colors"
      style={{
